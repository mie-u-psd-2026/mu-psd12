...
const { default: AppRoot } = await import('../components/AppRoot.js');
const { useSheetSession } = await import('../composables/useSheetSession.js');
const { createEmptySheet, parseSheet } = await import('../utils/sheet_format.js');
const { prepareProposal } = await import('../utils/ai_proposal.js');
const { stepPhysics } = await import('../utils/physics.js');
const { useUndoRedo } = await import('../composables/useUndoRedo.js');
